          ...
          <div style={{ background: 'rgba(245,245,245,.97)', border: '1px solid #ddd', borderRadius: 2, boxShadow: '0 2px 12px rgba(0,0,0,.12)', padding: 20 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20 }}>
              ...
              <div>
                ...
                <Link href="/cart" className="btn btn-red btn-lg" onClick={onAddToCart}>
              ...
              <div>
                <div className="price-calculator">
                  ...
                  <Link href="/cart" className="btn btn-red" style={{ width: '100%', display: 'block', textAlign: 'center' }} onClick={onAddToCart}>
                    <i className="fa-solid fa-cart-shopping"></i> ADD TO CART
                  </Link>
                </div>
