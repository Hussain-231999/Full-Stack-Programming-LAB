        ...
        <div className="container">
          ...
          <div className="content-box">
            ...
            <table className="account-table" style={{ marginBottom: 20 }}>
              ...
              <tbody>
                {['Five person hottube spa with green light inside','Five person hottube spa with green light inside'].map((name, i) => (
                  <tr key={i}><td><Link href="/product" style={{ color: '#2563eb' }}>{name}</Link></td><td>1</td><td style={{ textAlign: 'right' }}>$699.00</td></tr>
                ))}
              </tbody>
            </table>
            ...
            <div style={{ marginTop: 20 }}>
              <Link href="/my-account" className="btn btn-gray">← BACK TO ACCOUNT</Link>
            </div>
          </div>
        </div>
      </div>
