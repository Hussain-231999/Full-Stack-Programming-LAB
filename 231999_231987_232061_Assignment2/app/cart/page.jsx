        ...
        <div className="container">
          ...
          <div className="content-box">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '.78rem', color: '#555', marginBottom: 8 }}>
              <span>Items added: <Link href="/my-account" style={{ color: '#2563eb' }}>user_name</Link></span>
                  ...
                  <tr key={item.id}>
                    ...
                    <td>
                      ...
                      <div className="cart-links">
                        ...
                        <Link href="/product">Edit Your Order</Link>
                      </div>
                    </td>
            ...
            <div className="cart-summary">
              ...
              <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                <Link href="/category" className="btn btn-gray">CONTINUE SHOPPING</Link>
                <Link href="/checkout" className="btn btn-red">PROCEED TO CHECKOUT</Link>
              </div>
            </div>
          </div>
        </div>
