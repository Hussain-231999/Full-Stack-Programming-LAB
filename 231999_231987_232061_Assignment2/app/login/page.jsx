...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    setErrors(errs);
    if (Object.keys(errs).length === 0) router.push('/my-account');
  };
          ...
          <div className="content-box">
            <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 0 }}>
              <div style={{ paddingRight: cols !== '1fr' ? 28 : 0 }}>
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div style={{ marginLeft: 160, display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
                    ...
                    <Link href="/forgot-password" style={{ fontSize: '.82rem', color: '#2563eb' }}>Forgot your password?</Link>
                  </div>
                </form>
              </div>
              ...
              <div style={{ paddingLeft: cols !== '1fr' ? 28 : 0, paddingTop: cols === '1fr' ? 20 : 0 }}>
                ...
                <Link href="/register" className="btn btn-red">CREATE NEW ACCOUNT</Link>
              </div>
            </div>
          </div>
        </div>
