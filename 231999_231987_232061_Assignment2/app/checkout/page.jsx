...
export default function Checkout() {
  ...
  const handleSubmit = (e) => {
    ...
    const errs = validate();
    setErrors(errs);
    if (Object.keys(errs).length === 0) router.push('/order-summary');
  };
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 30 }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
                    ...
                    <label htmlFor="terms" style={{ fontSize: '.8rem', cursor: 'pointer' }}><Link href="/terms" style={{ color: '#2563eb' }}>I Accept terms and Conditions</Link></label>
                  </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #ddd', marginTop: 24, paddingTop: 16, flexWrap: 'wrap', gap: 10 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                  <Link href="/cart" className="btn btn-gray">Continue shopping</Link>
